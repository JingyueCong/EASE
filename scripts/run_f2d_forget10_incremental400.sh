...
V59="${F2D_FORGET10_V59_OUTPUT:-$WORK/forget10_author_semantic_agent200_seed${SEED}_v5_9_new_v1.jsonl}"
V59_PROFILES="${F2D_FORGET10_V59_PROFILES:-$V59.profiles.json}"
V59_STATE="${F2D_FORGET10_V59_STATE:-$V59.blocks}"
V511="${F2D_FORGET10_V511_OUTPUT:-$WORK/forget10_author_premisefix200_seed${SEED}_v5_11_new_v1.jsonl}"
V511_PROFILES="${F2D_FORGET10_V511_PROFILES:-$V511.profiles.json}"
V511_STATE="${F2D_FORGET10_V511_STATE:-$V511.blocks}"
V511_BASE="${F2D_FORGET10_V511_BASE_OUTPUT:-$WORK/forget10_author_premisefix200_seed${SEED}_v5_11_new_v1_pairbudget_base.jsonl}"
V511_BASE_PROFILES="${F2D_FORGET10_V511_BASE_PROFILES:-$V511_BASE.profiles.json}"
V512_NEW="${F2D_FORGET10_V512_NEW_OUTPUT:-$WORK/forget10_author_pairbudget200_seed${SEED}_v5_12_new_v1.jsonl}"
V512_NEW_PROFILES="${F2D_FORGET10_V512_NEW_PROFILES:-$V512_NEW.profiles.json}"
V512_STATE="${F2D_FORGET10_V512_STATE:-$V512_NEW.blocks}"

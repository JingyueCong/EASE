...
class ContrastGenerationMixin(GenerationMixin):
    ...
    def generate(
        ...
        **kwargs,
        ...
        # transformers >= 4.45 requires _prepare_special_tokens to set
        # _eos_token_tensor / _pad_token_tensor on generation_config before
        # _get_logits_processor is called.
        if hasattr(self, "_prepare_special_tokens"):
            try:
                self._prepare_special_tokens(generation_config, kwargs_has_attention_mask=("attention_mask" in model_kwargs))
            except TypeError:
                # older signature (no kwargs_has_attention_mask)
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        # transformers >= 4.45 needs cache_position in model_kwargs
